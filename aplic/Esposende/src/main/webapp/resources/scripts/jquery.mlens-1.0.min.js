(function (d) {
    var e = [], a = 0;
    var b = {init: function (f) {
        this.each(function () {
            var k = {lensShape: "square", lensSize: 100, borderSize: 4, borderColor: "#888", borderRadius: 0, imgSrc: "", lensCss: ""}, n = d(this), j = n.data("mlens"), h = d(), g = d(), i = d(), l = d();
            h = d.extend(k, f);
            if (h.imgSrc == "") {
                h.imgSrc = n.attr("src")
            }
        ...
        g = c(g);
        var l = e[g], f = l.lens, h = l.target, j = l.imageTag, k = f.offset(), i = parseInt(n.pageX - k.left), m = parseInt(n.pageY - k.top), p = j.width() / f.width(), o = j.height() / f.height();
        if (i > 0 && m > 0 && i < f.width() && m < f.height()) {
            ...
            i = "0"; //String((n.pageX - k.left - h.width() / 2)+100);
            m = "0"; //String((n.pageY - k.top - h.height() / 2)+100);
